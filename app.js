...
const stageViews = {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { kind: "folder", icon: "image-folder", label: "3D 비주얼 디자인", section: "design", root: true },
          { kind: "folder", icon: "image-folder", label: "브랜드 디자인", section: "branding", root: true },
  ...
  design: {
    title: "3D 비주얼 디자인",
    path: "Silt / 3D 비주얼 디자인",
    note: "3D 그래픽과 AI 기술을 활용해 브랜드와 제품의 가치를 시각적으로 구현합니다.",
    groups: [
      {
        className: "intro-files",
        items: [
  ...
  branding: {
    title: "브랜드 디자인",
    path: "Silt / 브랜드 디자인",
    note: "브랜드의 방향과 감도를 로고, 그래픽 시스템, 시각 언어로 정리합니다.",
    groups: [
      {
        className: "intro-files",
        items: [
  ...
  shooting: {
    title: "촬영",
    path: "Silt / 촬영",
    note: "현장의 분위기와 제품의 본질을 가장 효과적인 시선으로 담아냅니다.",
    groups: [
      {
        className: "intro-files",
        items: [
...
const defaultSiteText = {
  ...
  targetEmail: "omniscient@kakao.com",
...
const defaultWorks = [
  {
    ...
    kind: "서비스 카테고리",
    title: "3D 비주얼 디자인",
    headline: "3D 그래픽과 AI 기술을 활용해 브랜드와 제품의 가치를 시각적으로 구현합니다.",
    subtitle: "제품 렌더, AI 이미지 확장, 키비주얼, 캠페인 3D 비주얼",
    popupName: "3D 비주얼 디자인 상세",
    category: "Service",
    status: "공개",
    note: "3D 그래픽과 AI 기술을 활용해 브랜드와 제품의 가치를 시각적으로 구현합니다.",
    thumbnailAssetId: "",
  },
  {
    ...
    kind: "서비스 카테고리",
    title: "브랜드 디자인",
    headline: "브랜드의 감도와 방향을 시각 시스템으로 정리합니다.",
    subtitle: "로고, 브랜드 그래픽, 비주얼 아이덴티티, 응용 디자인",
    popupName: "브랜드 디자인 상세",
    category: "Service",
    status: "공개",
    note: "브랜드의 방향과 감도를 로고, 그래픽 시스템, 시각 언어로 정리합니다.",
    thumbnailAssetId: "",
  ...
  {
    id: "magic-girl-project",
    kind: "프로젝트 폴더",
    title: "마법소녀 Project",
    headline: "환상적인 캐릭터 무드를 3D/그래픽 레이어로 구축한 프로젝트",
    subtitle: "SF 판타지, 캐릭터 비주얼, 캠페인 그래픽",
    popupName: "마법소녀 Project 상세",
    category: "3D Visual",
    service: "design",
    status: "공개",
    note: "판타지적 이미지를 미래적인 색감과 입체 그래픽으로 구성한 대표 작업.",
    thumbnailAssetId: "",
    featuredInSidebar: true,
  },
  {
    id: "collie-wave-cover",
    kind: "프로젝트 폴더",
    title: "Collie Wave 음원 앨범커버",
    headline: "음원의 결을 그래픽 표면과 컬러 레이어로 정리한 앨범커버",
    subtitle: "Album Cover, Graphic Design",
    popupName: "Collie Wave 음원 앨범커버 상세",
    category: "Album Cover",
    service: "design",
    status: "공개",
    note: "사운드의 파동감을 시각적인 레이어와 표면 질감으로 옮긴 커버 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "hyokke-cover",
    kind: "프로젝트 폴더",
    title: "효끄 음원 앨범커버",
    headline: "아티스트의 톤을 압축한 음원 커버 디자인",
    subtitle: "Album Cover, Art Direction",
    popupName: "효끄 음원 앨범커버 상세",
    category: "Album Cover",
    service: "design",
    status: "공개",
    note: "음원 분위기와 아티스트 이미지를 한 장의 커버 안에 정리한 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "campaign-3d-visual",
    kind: "프로젝트 폴더",
    title: "캠페인 3D 비주얼 제작",
    headline: "캠페인의 중심 장면을 3D 비주얼로 구현한 작업",
    subtitle: "3D Campaign Visual",
    popupName: "캠페인 3D 비주얼 제작 상세",
    category: "3D Visual",
    service: "design",
    status: "공개",
    note: "브랜드 캠페인에 필요한 키비주얼과 응용 이미지를 3D 기반으로 제작.",
    thumbnailAssetId: "",
  },
  {
    id: "pixpills-popup",
    kind: "프로젝트 폴더",
    title: "pixpills pop-up 참여작",
    headline: "팝업 공간의 감각을 그래픽 이미지로 확장한 참여작",
    subtitle: "Pop-up, Graphic Asset",
    popupName: "pixpills pop-up 참여작 상세",
    category: "Exhibition",
    service: "design",
    status: "공개",
    note: "팝업 프로젝트 안에서 브랜드 무드와 공간성을 연결한 그래픽 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "rbw-beginning-project",
    kind: "프로젝트 폴더",
    title: "RBW the beginning project",
    headline: "프로젝트의 시작점을 시각 언어로 정리한 그래픽 작업",
    subtitle: "Project Graphic, Visual System",
    popupName: "RBW the beginning project 상세",
    category: "Graphic Design",
    service: "design",
    status: "공개",
    note: "프로젝트의 방향성과 초기 이미지를 그래픽 시스템으로 정리.",
    thumbnailAssetId: "",
  },
  {
    id: "illerdot-group-project",
    kind: "프로젝트 폴더",
    title: "일러닷 단체적 참여작",
    headline: "단체 프로젝트 안에서 그래픽 언어를 쌓아간 참여 작업",
    subtitle: "Group Project, Graphic Design",
    popupName: "일러닷 단체적 참여작 상세",
    category: "Graphic Design",
    service: "design",
    status: "공개",
    note: "여러 작업 흐름 안에서 SILT의 시각적 질감을 더한 참여작.",
    thumbnailAssetId: "",
  },
  {
    id: "graphic-washing-exhibition",
    kind: "프로젝트 폴더",
    title: "Graphic Washing Exhibition 참여작",
    headline: "전시 맥락 안에서 그래픽의 표면과 흔적을 실험한 작업",
    subtitle: "Exhibition, Graphic Design",
    popupName: "Graphic Washing Exhibition 참여작 상세",
    category: "Exhibition",
    service: "design",
    status: "공개",
    note: "그래픽이 씻기고 남는 흔적을 전시적 이미지로 구성한 참여작.",
    thumbnailAssetId: "",
  },
  {
    id: "yonsei-ryu-poster",
    kind: "프로젝트 폴더",
    title: "연세대학교 RYU 포스터 제작",
    headline: "행사의 성격과 리듬을 정리한 포스터 디자인",
    subtitle: "Poster, Editorial Graphic",
    popupName: "연세대학교 RYU 포스터 제작 상세",
    category: "Poster",
    service: "design",
    status: "공개",
    note: "행사 정보와 분위기를 명확한 시각 구조로 정리한 포스터 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "ssaemi-cover",
    kind: "프로젝트 폴더",
    title: "쌔미 음원 앨범커버",
    headline: "음원의 정서를 그래픽 이미지로 압축한 앨범커버",
    subtitle: "Album Cover",
    popupName: "쌔미 음원 앨범커버 상세",
    category: "Album Cover",
    service: "design",
    status: "공개",
    note: "아티스트의 톤과 음원의 감정을 하나의 표지 이미지로 정리.",
    thumbnailAssetId: "",
  },
  {
    id: "im-jaeyoung-album-credit",
    kind: "프로젝트 폴더",
    title: "임재영 음원 앨범 및 크레딧",
    headline: "음원 앨범과 크레딧 그래픽을 함께 정리한 작업",
    subtitle: "Album Cover, Credit Design",
    popupName: "임재영 음원 앨범 및 크레딧 상세",
    category: "Album Cover",
    service: "design",
    status: "공개",
    note: "음원 커버와 크레딧 정보를 하나의 그래픽 흐름으로 구성.",
    thumbnailAssetId: "",
  },
  {
    id: "other-album-covers",
    kind: "프로젝트 폴더",
    title: "그 외 앨범커버 참여작",
    headline: "다양한 음원의 무드를 시각화한 앨범커버 아카이브",
    subtitle: "Album Cover Archive",
    popupName: "그 외 앨범커버 참여작 상세",
    category: "Album Cover",
    service: "design",
    status: "공개",
    note: "여러 아티스트와 음원의 표정을 축적한 커버 디자인 아카이브.",
    thumbnailAssetId: "",
  },
  {
    id: "yeopkeopon",
    kind: "프로젝트 폴더",
    title: "옆커폰",
    headline: "로컬 서비스의 접점을 정리한 마케팅 작업",
    subtitle: "Marketing, Local Campaign",
    popupName: "옆커폰 상세",
    category: "Marketing",
    service: "marketing",
    status: "공개",
    note: "브랜드 접점과 채널 흐름을 정리한 마케팅 프로젝트.",
    thumbnailAssetId: "",
  },
  {
    id: "daegu-now",
    kind: "프로젝트 폴더",
    title: "대구는지금",
    headline: "지역 기반 콘텐츠 흐름을 정리한 마케팅 작업",
    subtitle: "Marketing, Content",
    popupName: "대구는지금 상세",
    category: "Marketing",
    service: "marketing",
    status: "공개",
    note: "지역성과 콘텐츠 흐름을 연결한 마케팅 운영 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "weddingmi-brand",
    kind: "프로젝트 폴더",
    title: "웨딩미 브랜드 디자인",
    headline: "웨딩 브랜드의 감도와 신뢰감을 정리한 브랜드 디자인",
    subtitle: "Brand Design",
    popupName: "웨딩미 브랜드 디자인 상세",
    category: "Brand Design",
    service: "branding",
    status: "공개",
    note: "브랜드 방향과 그래픽 톤을 웨딩 서비스에 맞게 정리한 작업.",
    thumbnailAssetId: "",
    featuredInSidebar: true,
  },
  {
    ...
    kind: "프로젝트 폴더",
    title: "혜윰 로고 디자인",
    headline: "브랜드 이름의 인상을 응축한 로고 디자인",
    subtitle: "Logo Design",
    popupName: "혜윰 로고 디자인 상세",
    category: "Brand Design",
    service: "branding",
    status: "공개",
    note: "이름의 뉘앙스와 서비스 성격을 조형적인 로고로 정리.",
    thumbnailAssetId: "",
  },
  {
    id: "peakstudio-brand",
    kind: "프로젝트 폴더",
    title: "피크스튜디오 브랜드디자인",
    headline: "스튜디오의 정체성을 그래픽 시스템으로 구성한 브랜드 작업",
    subtitle: "Brand Design",
    popupName: "피크스튜디오 브랜드디자인 상세",
    category: "Brand Design",
    service: "branding",
    status: "공개",
    note: "촬영 스튜디오의 감도와 운영 이미지를 브랜드 디자인으로 정리.",
    thumbnailAssetId: "",
  },
  {
    id: "gather-together-brand",
    kind: "프로젝트 폴더",
    title: "게더투게더 브랜드 디자인",
    headline: "함께 모이는 경험을 시각 언어로 정리한 브랜드 디자인",
    subtitle: "Brand Design",
    popupName: "게더투게더 브랜드 디자인 상세",
    category: "Brand Design",
    service: "branding",
    status: "공개",
    note: "브랜드의 관계성과 분위기를 로고와 그래픽 시스템으로 정리.",
    thumbnailAssetId: "",
    featuredInSidebar: true,
  },
  {
    id: "cogflow-content-shooting",
    kind: "프로젝트 폴더",
    title: "코그플로우 콘텐츠 촬영",
    headline: "브랜드 콘텐츠에 필요한 장면을 정돈한 촬영 작업",
    subtitle: "Content Shooting",
    popupName: "코그플로우 콘텐츠 촬영 상세",
    category: "Shooting",
    service: "shooting",
    status: "공개",
    note: "서비스의 성격과 제품의 맥락을 콘텐츠 컷으로 구성한 촬영.",
    thumbnailAssetId: "",
    featuredInSidebar: true,
  },
  {
    id: "gather-together-shooting",
    kind: "프로젝트 폴더",
    title: "게더투게더 콘텐츠 촬영",
    headline: "브랜드 경험을 자연스러운 장면으로 기록한 콘텐츠 촬영",
    subtitle: "Content Shooting",
    popupName: "게더투게더 콘텐츠 촬영 상세",
    category: "Shooting",
    service: "shooting",
    status: "공개",
    note: "현장의 분위기와 브랜드 이미지를 콘텐츠 컷으로 연결한 작업.",
    thumbnailAssetId: "",
  },
  {
    id: "peakstudio-wedding-shooting",
    kind: "프로젝트 폴더",
    title: "피크스튜디오 웨딩 촬영",
    headline: "웨딩 현장의 감정과 분위기를 정리한 촬영 작업",
    subtitle: "Wedding Shooting",
    popupName: "피크스튜디오 웨딩 촬영 상세",
    category: "Shooting",
    service: "shooting",
    status: "공개",
    note: "공간, 인물, 감정의 결을 가장 좋은 구도로 담아낸 웨딩 촬영.",
    thumbnailAssetId: "",
  },
  {
    id: "weplay-interview-shooting",
    kind: "프로젝트 폴더",
    title: "위플레이 인터뷰 촬영",
    headline: "사람과 메시지를 명확하게 담아낸 인터뷰 촬영",
    subtitle: "Interview Shooting",
    popupName: "위플레이 인터뷰 촬영 상세",
    category: "Shooting",
    service: "shooting",
    status: "공개",
    note: "인터뷰의 흐름과 메시지를 안정적인 시선으로 구성한 촬영.",
    thumbnailAssetId: "",
  },
];
...
const defaultImageSlots = [
  ...
  { id: "design", title: "3D 비주얼 디자인 프리뷰", description: "3D 비주얼 디자인 카테고리 오른쪽 패널 이미지", assetId: "" },
  { id: "branding", title: "브랜드 디자인 프리뷰", description: "브랜드 디자인 카테고리 오른쪽 패널 이미지", assetId: "" },
...
function buildProjectFolderItems(projectWorks, serviceSection = "") {
  const scopedWorks = serviceSection ? projectWorks.filter((work) => work.service === serviceSection) : projectWorks;
    ...
    if (existingView && work.kind === "서비스 카테고리") {
      ...
      existingView.groups = [
        ...
        },
        {
          title: text("navWorksTitle"),
          className: "folder-grid project-grid",
          items: buildProjectFolderItems(projectWorks, section),
        },
      ];
      return;
    }
...
function renderSidebar() {
  ...
  const works = getPublicWorks().filter((work) => work.status !== "비공개");
  const serviceWorks = works.filter((work) => work.kind === "서비스 카테고리");
  const projectWorks = works.filter((work) => work.kind !== "서비스 카테고리" && work.featuredInSidebar);
...
function applyManagedContent() {
  ...
  ["design", "branding", "marketing", "shooting"].forEach(renderServicePanel);
  renderContactPanel();
}
